...
export class Button implements Object {
  ...
  Button = () => {
    return (
      <div className="choose-truth-dare__button-list
      ">
        <button className="choose-truth-dare__button-truth">真実</button>
        <button className="choose-truth-dare__button-dare">挑戦</button>
      </div>
    )
  }
